...
public class GoldAddCommand extends SlashCommand {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GoldAddCommand.class);
    ...
    public void execute(SlashCommandEvent event) throws Exception {
        ...
        goldStockService.add(guildId, server, quantity, userId);
        ...
        event.reply("Foi adicionado **%s** de gold no bloco do **%s**. Saldo atual: ***%s*** - __**%s**__",
